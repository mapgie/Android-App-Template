...
-keep class com.example.myapp.data.database.entities.** { *; }

# Room — DAO interfaces are referenced by generated code; keep all members
-keep interface com.example.myapp.data.database.dao.** { *; }
-keep class com.example.myapp.data.database.dao.**_Impl { *; }
